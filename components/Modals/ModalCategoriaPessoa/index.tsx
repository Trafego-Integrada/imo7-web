...
const ModalBase = ({ departamentoId }, ref) => {
    ...
    const buscar = useMutation(buscarCategoriaPessoa, {
        onSuccess: (data) => {
            reset(data);
            onOpen();
        },
    });
    const cadastrar = useMutation(cadastrarCategoriaPessoa, {
        onSuccess: () => {
    ...
    const atualizar = useMutation(atualizarCategoriaPessoa, {
        onSuccess: () => {
            queryClient.invalidateQueries(["categoriasPessoa"]);
    ...
    return (
        <>
            <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    <ModalHeader>
                        Categoria de Pessoa <ModalCloseButton />
                    </ModalHeader>
                    <ModalBody>
                        <Grid
                            gap={5}
...
export const ModalCategoriaPessoa = forwardRef(ModalBase);
