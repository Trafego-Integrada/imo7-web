                ...
                <ModalBody>
                    <Tabs variant='unstyled'>
                        <TabList>
                            ...
                            <Tab _selected={{ color: 'white', bg: 'blue.500' }}>Documentos</Tab>
                            <Tab _selected={{ color: 'white', bg: 'blue.500' }}>Imóveis</Tab>
                        </TabList>
                        <TabPanels>
                            <TabPanel>
                                <Grid
                            ...
                            <TabPanel>
                                ...
                                <Grid d='flex' gap={3}>
                                    <Button
                                        ...
                                        _hover={{ bg: 'bluelight', color: 'white', cursor: 'pointer' }}
                                        _focus={{ bg: 'none' }}
                                        _active={{ bg: 'none' }}
                                        color='bluelight'
                                    >
                                    ...
                                    <Button
                                        ...
                                        _hover={{ bg: 'orange', color: 'white', cursor: 'pointer' }}
                                        _focus={{ bg: 'none' }}
                                        _active={{ bg: 'none' }}
                                        color='orange'
                                    >
